		...
		<nav>
			<ul class="navig">
				...
				<li>
					<a>News</a>
					<ul class="menu">
						<li><a href="Actualite.html">Match schedule</a></li>
						<li><a href="historique.html">Meeting History</a></li>
					</ul>
				</li>
				<li><a href="Foot/projet/tourisme.html">Tourism Area</a></li>
				<li><a href="Foot2/index.php">Buy my Tickets</a></li>
			</ul>
			...
			<div class="dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
					<a class="dropdown-item" href="index.php"> French </a>
				...
				<div class="modal-dialog modal-dialog-centered">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<button class="btn btn-success"><a href="Foot/index.php">Sign up now</a></button>
						</div>
						...
						<div class="modal-body">
							<form>
								<div class="form-group">
								    ...
								    <small id="emailHelp" class="form-text text-muted">Please enter your username or email address</small>
								</div>
								<div class="form-group">
								    <div class="input-group form-group">
										<div class="input-group-prepend">
